                        ...
                        <div class="productList">
                            <ul id="product">
                                <a v-for="(Sp,index) in SpList" :key="index">
                                    <li>
                                        <div>
                                            <img @click="$router.openPage('/teaMallShopProduct',{id:Sp.goodsCode,releaseCode:Sp.releaseCode})" class="productList-img" :src="Sp.appSmallPicture">
                                        </div>
                                        ...
                                        <div class="productList-time c-yellow">
                                            <span class="fl">上市时间：{{Sp.param1}}</span>
                                        ...
                                        <div class="productList-quantity">
                                            ...
                                            <span>
                                                <div>{{Sp.param2-+Sp.param1}}{{Sp.benchmarkingUnit3}}</div>
...
import qs from 'qs';
    export default ({
        ...
        methods: {
            ...
            getList(){
                this.axios.post(this.http+'/interface/pc/allotment/shoppingMall',qs.stringify({
                    sort:this.sort,
                    ...
                    console.log(JSON.parse(res.data.data),'wwwwwwwwwwwwwwwwwwwww');
                    this.SpList=JSON.parse(res.data.data).allotmentList;
                    this.brandList=JSON.parse(res.data.data).brandList;
                    this.placeOriginList=JSON.parse(res.data.data).placeOriginList;
