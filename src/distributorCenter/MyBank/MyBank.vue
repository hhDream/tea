        ...
        <el-col class="outFromBox" :span="24">
          <el-form label-width="150px" class="demo-ruleForm">
            ...
            <el-form-item label="银行卡开户地区">
              <el-cascader expand-trigger="hover" :options="address" :prop='prop' v-model="addrs">
              </el-cascader>
            </el-form-item>
            <el-form-item>
...
export default {
  ...
  methods: {
    ...
    binding() {
      ...
      this.axios
        .post(
          this.http + "/interface/pc/distributor/pcBank/openPersonal",
          qs.stringify({
            userName: this.username,
            cerId: this.idcard,
            phone: this.mobilephone,
            custProv: this.arrs[0],
            custArea: this.arrs[1]
          })
        )
        .then(res => {
          if (res.data.code == 200) {
