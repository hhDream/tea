    ...
    <div>
        <el-row>
            ...
            <el-col :span="22">
                ...
                <div v-if="radio==2"><el-radio v-model="radio2" label="" style="margin-top:20px">详细地址：{{ product.postalAddress }}  手机：{{ phone }}</el-radio><br></div>
                <div v-if="radio==1"><el-radio v-model="radio2" label="" style="margin-top:20px">详细地址：{{ address.postalAddress }}  手机：{{ phone }}</el-radio><br></div>
            </el-col>
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.axios
        .post(
          this.http + "/interface/pc/distributor/pcDistributor/myAddress",
          qs.stringify({
        ...
        .then(res => {
          if (res.data.code == 200) {
            this.address = JSON.parse(res.data.data);
          }
        });
    },
    changeState() {
