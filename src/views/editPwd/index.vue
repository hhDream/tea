<template>
  <div class="box">
    ...
    <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item>
        <el-button type="primary" @click="tips()">提交</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      validateCode() {
        this.axios.post('http://192.168.1.105:8080/tea/interface/pc/personal/pcEnterprise/validateCode', qs.stringify({
          phone:this.phone,
